...
import com.example.minichatapp.network.Api
...
object AppModule {
    ...
    @Provides
    @Singleton
    fun provideFirebaseSFirestoreInstance(): FirebaseFirestore = FirebaseFirestore.getInstance()
    ...
    fun provideRemoteMsgHeaders(@ApplicationContext context: Context) =
        HashMap<String,String>().apply {
            put(Constant.REMOTE_MSG_AUTHORIZATION, String.format("key=%s",context.getString(com.google.android.material.R.string.fab_transformation_scrim_behavior)))
